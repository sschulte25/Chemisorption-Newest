...
BEGIN_MARK = "@nautilus_begin"
END_MARK = "@nautilus_end"

NAUTILUS_PATH = os.path.dirname(os.path.realpath(sys.argv[0]))

NAUTILUS_ADDON = """# %s DO NOT EDIT !
#########################################

# To access nautilus folder via 'cd $nautilus'
nautilus="%s"

# import bash commands from a Git file
source $nautilus/.nautilus_profile

#########################################
# %s DO NOT EDIT !""" % (BEGIN_MARK, NAUTILUS_PATH, END_MARK)
...
" * uninstall: To suppress any command that were previously added to the .bashprofile
...
object_file.write(NAUTILUS_ADDON)
