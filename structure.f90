...
if (isDefined) then
  ...
  allocate(GTODN_1D(nb_values))
  allocate(grain_radius_1D(nb_values))
  ...
  GTODN_1D(1:nb_values)=tmp_GTODN_1D(1:nb_values)
  grain_radius_1D(1:nb_values)=tmp_grain_radius_1D(1:nb_values)
